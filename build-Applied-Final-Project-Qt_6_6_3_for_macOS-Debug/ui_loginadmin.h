...
public:
    ...
    void setupUi(QDialog *Loginadmin)
    {
        ...
        lineEdit->setGeometry(QRect(70, 100, 151, 21));
        lineEdit_2 = new QLineEdit(Loginadmin);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(70, 160, 161, 21));
        label = new QLabel(Loginadmin);
        label->setObjectName("label");
        label->setGeometry(QRect(40, 70, 181, 21));
        label_2 = new QLabel(Loginadmin);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(40, 130, 201, 20));
